        ...
        while ((c = getopt(argc, argv, "ha:p:u:f:r:c:v:w:t:F:d")) != -1) {
                switch (c) {
                        case 'a':
                                ...
                                break;
                        case 'p':
                                cfg.port = strtoul(optarg, nullptr, 10);
                                break;
                        case 'u':
                                cfg.unit_id = strtoul(optarg, nullptr, 10);
                                break;

                        case 'f':
                                cfg.function = strtoul(optarg, nullptr, 10);
                                break;
                        case 'r':
                                cfg.reg = strtoul(optarg, nullptr, 10);
                                break;
                        case 'c':
                                cfg.count = strtoul(optarg, nullptr, 10);
                                break;
                        case 'v':
                                cfg.value = strtoul(optarg, nullptr, 10);
                                break;
                        ...
                        case 't':
                                cfg.timeout = strtoul(optarg, nullptr, 10);
                                break;
                        case 'd':
                                cfg.debug = true;
